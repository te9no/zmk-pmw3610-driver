...
#include <zmk/events/activity_state_changed.h>  // Add this line
...
#define PMW3610_DEFINE(n)                                                  \
    ...
    static struct ball_action_cfg *ball_actions##n[] = {                  \
        DT_INST_FOREACH_CHILD(0, BALL_ACTIONS_ITEM)                      \
    };                                                                    \
    static const uint8_t scroll_layers##n[] = DT_PROP_OR(DT_DRV_INST(n), scroll_layers, {0}); \
    static const uint8_t snipe_layers##n[] = DT_PROP_OR(DT_DRV_INST(n), snipe_layers, {0});  \
    ...
    DEVICE_DT_INST_DEFINE(n, pmw3610_init, NULL,                         \
                         ...
                         CONFIG_INPUT_PMW3610_INIT_PRIORITY,             \
                         &pmw3610_driver_api);
